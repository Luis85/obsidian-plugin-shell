...
with sync_playwright() as pw:
    ...
    try:
        ...
        check('Example contains 24 surfaces and 30 mapped requirements', js('projectTransferUi.candidate.design.nodes.length===24 && allRequirements(projectTransferUi.candidate.design).length===30'))
