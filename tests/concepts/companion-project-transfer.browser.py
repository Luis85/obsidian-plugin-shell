...
with sync_playwright() as pw:
    ...
    try:
        ...
        check('Example contains 22 surfaces and 25 mapped requirements', js('projectTransferUi.candidate.design.nodes.length===22 && allRequirements(projectTransferUi.candidate.design).length===25'))
        ...
        check('Example includes entities, source operations, recipes and design tokens', js('projectTransferUi.candidate.design.semantic.entities.length===9 && projectTransferUi.candidate.design.dataSources.sources[0].operations.length===3 && projectTransferUi.candidate.design.designSystem.colors.length===5'))
