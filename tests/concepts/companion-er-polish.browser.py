...
with sync_playwright() as pw:
    ...
    try:
        ...
        ok('Secondary ports become visible on entity hover', page.locator(f'[data-entity="{person}"] .er-secondary-port').first.evaluate('(e)=>getComputedStyle(e).opacity')=='1')
        page.mouse.move(10,10)
        ok('Secondary ports recede without being removed from layout', page.locator(f'[data-entity="{person}"] .er-secondary-port').first.evaluate('(e)=>getComputedStyle(e).opacity')=='0')
