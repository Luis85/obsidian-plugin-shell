...
`docs/concepts/companion/index.html`: **1,232,189 bytes**, SHA-256:

```text
63a538975580324c7c2445601bbd2fbdf17b937263a19dcfdcc88ae50f3040d4
```
...
| New ER geometry, guidelines and interaction-state suite | 66 passed |
...
| **Current browser assertions, excluding blocked storage execution** | **459 passed** |
...
Assertion totals include model, synthetic/control-state, computed-style and geometry checks, not 459 independent physical-pointer journeys. No observed page/console errors or external runtime requests occurred in the completed local suites.
