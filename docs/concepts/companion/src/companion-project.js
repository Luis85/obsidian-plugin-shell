...
function companionExampleProject() {
  ...
  d.designSystem.description = 'Host-friendly design declarations compiled into scoped Nuxt UI styles by the shell generator; custom component layout remains an implementation task.';
