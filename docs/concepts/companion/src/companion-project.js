...
function companionExampleProject() {
  ...
  d.designSystem.description = 'Host-friendly design tokens for component previews and generated detail surfaces. Published component revisions retain their own reviewed token snapshot.';
