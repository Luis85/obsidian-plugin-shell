...
function resetFlowConnection(announce=false){
 ...
 flowUi.cancelled=true;connectionUi.pointer=null;flowUi.api?.endConnection(undefined,true);setFlowConnecting(false);closeConnectionMenu(false);
