...
function designFiles(d){
 ...
 for(const n of d.nodes){
  ...
  const spec={nodeId:n.id,kind:n.kind,label:n.label,layout:n.layout,placement:nodePlacement(d,n),parent:n.parent,instance:n.instance,patterns:n.patterns,intent:n.intent||'',userGoals:n.goals||[],contentBricks:bricksOf(n)};
