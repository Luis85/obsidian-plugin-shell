...
function structuralDesign(value){
 if(!value||![1,2,3].includes(value.schema)||!Array.isArray(value.nodes)||value.nodes.length>DESIGN_LIMITS.nodes||!Array.isArray(value.links)||value.links.length>DESIGN_LIMITS.links)return false;
