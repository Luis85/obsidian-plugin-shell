...
export async function component(context, { owner, name, editable = false, repository }) {
  ...
  async function create() {
    ...
    try {
      ...
      if (!prepared.ok) { feedback.value = t(prepared.error.key); return; }
  ...
  return { t, inputId, model, busy, blocked, feedback, create };`;
