...
export const commands: readonly Command[] = [
  ...
  { id: 'new', summary: 'Create a new plugin project from a reviewed starter or an exported companion project (--from); previews unless --yes.', options: { ...values('starter', 'from', 'id', 'name', 'author'), list: 'flag', install: 'flag', 'inside-vault': 'flag' }, maxArgs: 1, effect: 'plan' },
