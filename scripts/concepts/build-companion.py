...
def build(output: Path, check: bool = False):
 ...
 change("function render(){", "function render(){if(state.view!=='testdata'||tdUi.sessionKey&&tdUi.sessionKey!==tdFingerprint())tdDropSession();const uiFocus=captureUiFocus();smDestroy();erDestroy();destroyFlow();if(project())normalizeSitemapSelection();")
 change("document.getElementById('storage-status').className=storageWarning?'storage-alert':'';save();", "document.getElementById('storage-status').className=storageWarning?'storage-alert':'';save();afterCanvasRender();erMount();smMount();workflowDecorate();workbenchControlMetadata();restoreUiFocus(uiFocus);")
 change("el?.focus();}\nfunction closeModal", "el?.focus();if(modalOriginal===null)rememberModalForm();workflowModalPolish();}\nfunction closeModal")
 change("document.getElementById('modal').innerHTML=(factories[modalType]", "document.getElementById('modal').classList.toggle('storymap-modal',modalType==='storymap-form');document.getElementById('modal').classList.toggle('test-data-modal',modalType==='test-data-form');document.getElementById('modal').classList.toggle('data-source-modal',modalType==='data-source-form');document.getElementById('modal').classList.toggle('semantic-modal',modalType==='semantic-form');document.getElementById('modal').classList.toggle('reference-content-modal',modalType==='ref-content');document.getElementById('modal').innerHTML=(factories[modalType]")
 # Insert the new modules before the final render, so no runtime override/eval is needed.
 modules=['storymap-model.js','storymap-actions.js','storymap-forms.js','storymap-views.js','storymap-runtime.js','storymap-export.js','storymap-seed.js','project-transfer.js','companion-project.js','ui-fields.js','style-guide-actions.js','style-guide-views.js','style-guide-export.js','test-data-actions.js','test-data-views.js','test-data-export.js','editor-selection.js','editor-removal.js','data-source-actions.js','data-source-views.js','data-source-flow.js','data-source-generation.js','semantic-geometry.js','semantic-interaction.js','semantic-actions.js','semantic-views.js','semantic-runtime.js','semantic-generation.js','vault-preparation.js','vault-workspace.js','state-safety.js','surface-view.js','edge-editing.js','unified-library.js','spatial-model.js','spatial-runtime.js','reference-model.js','reference-views.js','reference-content.js','reference-actions.js','library-model.js','library-views.js','library-actions.js','brick-model.js','brick-views.js','brick-actions.js','connection-model.js','connection-views.js','connection-menu.js','connection-actions.js','flow-model.js','flow-views.js','flow-actions.js','flow-runtime.js','flow-edge.js','workflow-model.js','workflow-views.js','workflow-actions.js','canvas-model.js','canvas-layout.js','canvas-view.js','canvas-actions.js','canvas-pointer.js','interaction-polish.js','product-model.js','component-views.js','prd-views.js','product-actions.js','product-plan.js','design-model.js','design-plan.js','design-views.js','design-dialogs.js','design-actions.js']
 # Register exact JS/CSS inputs, including retained hash-verified upstream CSS.
 styles=['workbench.css','design.css','product.css','canvas.css','workflow.css','flow.css','connection.css','bricks.css','library.css','reference.css','unified.css','surface.css','vault.css','semantic.css','component-variants.css','data-source.css','test-data.css','style-guide.css','storymap.css']
 ...
 shared=(storymap_contract.read_text()+'\n'+contract.read_text().replace("import { validateStorymaps } from './storymap-contract.mjs';\n",'')).replace('export const ', 'const ').replace('export function ', 'function ')
