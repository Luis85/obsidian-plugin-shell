...
function notice() { services.notifications.show(`${model.owner}:showcase-notice`, 'info', 'feedback.native', true); }
function expected() { services.notifications.show(`${model.owner}:showcase-example`, 'error', 'events.expected'); }
...
<template>
  ...
  <div class="shell-actions shell-demo-actions"><UButton icon="i-lucide-radio" @click="ping">{{ t('events.ping') }}</UButton><UButton color="neutral" variant="outline" icon="i-lucide-bell" @click="notice">{{ t('events.notice') }}</UButton><UButton color="neutral" variant="outline" icon="i-lucide-message-square-warning" @click="expected">{{ t('events.error') }}</UButton><UButton color="neutral" variant="outline" icon="i-lucide-panel-top" @click="modal">{{ t('events.modal') }}</UButton></div>
